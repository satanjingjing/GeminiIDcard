...
public class CreateQrcode_edit {
	...
	public static void main(String[] args) throws IOException {
        ...
        String str="我爱你，老爹，嘻嘻嘻";//二维码扫出来的内容
        ...
        Image logo=ImageIO.read(new File("D:/djxsQrcode/QQ头像.jpg"));
        int logosize=30;
        int logox=(imagesize-logosize)/2;
        gs1.drawImage(logo,logox, logox, logosize, logosize, null);
        gs1.dispose();
    	bufferedimage.flush();
    	ImageIO.write(bufferedimage,"png",new File("D:/djxsQrcode/qrlove.png"));
	}
}
